...
const cr13 = String.fromCharCode('&#013;');
const lf10 = String.fromCharCode('&#010;');
...
exports.generateTransferFile = asyncHandler(async (req, res) => {
  ...
  if (arrayWithTracks) {
    ...
    arrayWithTracks.forEach((track) => {
      ...
      const new_program_date = windows1252
      ...
      const new_program_start_time = windows1252.encode(
      ...
      console.log(
        'new program start time length',
        new_program_start_time.length
      );
      const new_programm_end_time = windows1252.encode(
      ...
      let new_track_title =
        track.track_title.replace(re, ' ').toUpperCase() +
        placeholder.track_title.substring(track.track_title.length);
      new_track_title = windows1252
      ...
      if (minutes.toString().length === 1) {
        minutes = windows1252.encode(`0${minutes.toString()}`);
      } else {
        minutes = windows1252.encode(minutes.toString());
      }
      if (seconds.toString().length === 1) {
        seconds = windows1252.encode(`0${seconds.toString()}`);
      } else {
        seconds = windows1252.encode(seconds.toString());
      }
      ...
      if (track.country === 1) {
        const intCountry = 1;
        new_country = windows1252.encode(intCountry.toString());
      } else {
        new_country = windows1252.encode(' ');
      }
      ...
      let new_artist_name =
        track.artist_name.replace(re, ' ').toUpperCase() +
        placeholder.artist_name.substring(track.artist_name.length);

      new_artist_name = windows1252
      ...
      if (track.disc_no === null) {
        new_disc_no = windows1252.encode(' ');
      } else if (track.disc_no.toString().length === 1) {
        new_disc_no = track.disc_no.toString();
        new_disc_no = windows1252.encode(new_disc_no, {
          mode: 'html',
        });
      } else {
        new_disc_no = windows1252
      ...
      if (track.track_no === null) {
        new_track_no = windows1252.encode('  ');
      } else if (track.track_no.toString().length === 1) {
        new_track_no = windows1252.encode(` ${track.track_no.toString()}`, {
          mode: 'html',
        });
      ...
      if (track.record_country === null || track.record_country === '') {
        new_record_country = windows1252.encode('   ');
      } else {
        new_record_country = windows1252.encode(`${track.record_country} `, {
          mode: 'html',
        });
      }
      ...
      let new_program_name =
        track.program_name.replace(re, ' ').toUpperCase() +
        placeholder.program_name.substring(track.program_name.length);
      new_program_name = windows1252
      ...
      if (track.year === null) {
        new_year = windows1252.encode('    ');
      } else {
        new_year = windows1252
          .encode(track.year, {
            mode: 'html',
          })
          .substring(0, 4);
      ...
      if (track.copyright_holders === null) {
        new_copyright_holder_1 = windows1252.encode(
          placeholder.copyright_holder_1
        );
        new_copyright_holder_2 = windows1252.encode(
          placeholder.copyright_holder_2
        );
        new_copyright_holder_3 = windows1252.encode(
          placeholder.copyright_holder_3
        );
        new_copyright_holder_4 = windows1252.encode(
          placeholder.copyright_holder_4
        );
        new_copyright_holder_5 = windows1252.encode(
          placeholder.copyright_holder_5
        );
      } else {
      ...
      console.log(
        'new copyright holder 1 length',
        new_copyright_holder_1.length
      );
      console.log('new copyright holder 2', new_copyright_holder_2);
      console.log(
        'new copyright holder 2 length',
        new_copyright_holder_2.length
      );
      console.log('new copyright holder 3', new_copyright_holder_3);
      console.log(
        'new copyright holder 3 length',
        new_copyright_holder_3.length
      );
      console.log('new copyright holder 4', new_copyright_holder_4);
      console.log(
        'new copyright holder 4 length',
        new_copyright_holder_4.length
      );
      console.log('new copyright holder 5', new_copyright_holder_5);
      console.log(
        'new copyright holder 5 length',
        new_copyright_holder_5.length
      );
      ...
      newArr.push({
        ...
        length: new_length,
        times: '0001',
        copyright_holder_1: windows1252.encode(new_copyright_holder_1, {
          mode: 'html',
        }),
        copyright_holder_2: windows1252.encode(new_copyright_holder_2, {
          mode: 'html',
        }),
        copyright_holder_3: windows1252.encode(new_copyright_holder_3, {
          mode: 'html',
        }),
        copyright_holder_4: windows1252.encode(new_copyright_holder_4, {
          mode: 'html',
        }),
        copyright_holder_5: windows1252.encode(new_copyright_holder_5, {
          mode: 'html',
        }),
        country: new_country,
